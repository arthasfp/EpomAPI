...
//
//        EpomService epomService = new EpomService(new User("supervisor", "c882be9238ce4a8fc5c6cd74a902f775", "https://n100.epom.com"));
...
//
//        PlacementTargetingAPI placementTargetingAPI = new PlacementTargetingAPI(new User("berezhnyi1234", "iloventv_89", "https://n101.epom.com"));
...
////        placementTargetingAPI.createBrowserTargeting(10315, "INCLUDE", "CHROME", "LOWER", 22.0);
//
////epomService.getAffiliate();
////        epomService.getList();
////epomService.deleteRule();
//    }
//
//    private void getList() throws NoSuchAlgorithmException, IOException {
//        String username = "oceanbys.com";
//        String password = "yeshujuan123";
//        String offerurl = "https://epomaffiliate.com/rest-api/affiliate/offers/list.do?" +
//                "username={USERNAME}&timestamp={TIMESTAMP}&hash={HASH}";
//        String timestamp = String.valueOf(System.currentTimeMillis());
//        String hash = getMD5((getMD5(password)) + timestamp);
//        offerurl = offerurl.replace("{USERNAME}", username);
//        offerurl = offerurl.replace("{TIMESTAMP}", timestamp);
//        offerurl = offerurl.replace("{HASH}", hash);
...
//
//
//    private void deleteRule() throws NoSuchAlgorithmException, IOException {
//        URL url = new URL(user.getNetwork() + "/rest-api/rule/4/delete.do?username=" + user.getUsername()+ "&timestamp=" + getTimestamp() + "&hash=" + getHash());
//        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
...
//
//
//    private void getAffiliate() throws NoSuchAlgorithmException, IOException {
//        URL url = new URL("https://epomaffiliate.com/rest-api/affiliate/offers/list.do?username=" + user.getUsername()+ "&timestamp=" + getTimestamp() + "&hash=" + getHash());
//        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
//        conn.setRequestMethod("GET");
//        getVerifierForConnection(conn);
//        System.out.println(conn.getResponseCode());
...
//        String hash = getMD5(user.getPassword() + String.valueOf(getTimestamp()));
//        return hash;
//    }
//
